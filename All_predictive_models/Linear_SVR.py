    ...
    for idx_run, vp in enumerate(rest_of_training):
        ...
        for c_val in list_C:
            for ep_val in list_ep:
                model = SVR(kernel='linear', gamma = 'auto', C = c_val, epsilon = ep_val)
                ...
                print("C_value: {} Epsilon_value:{} All_MSE: {} All_R2: {}".format(c_val, ep_val, all_mse, all_r2_score))

                if all_mse < min_mse:
                    min_mse = all_mse
                    best_C = c_val 
                    best_ep = ep_val
                    print("The best C value is: {} The best epsilon_value:{} The best mse: {}".format(best_C, best_ep, all_mse))
       
        regression = SVR(kernel='linear', gamma='auto', C=best_C, epsilon = best_ep)
...
#         plt.show()
        ...
        # read_book = open_workbook("Linear_SVR_allcon_win3_revised.xls")
        ...
        # write_book.save("Linear_SVR_allcon_win3_revised.xls")
