        ...
        for c_val in list_C:
            for gamma_val in list_gamma:
                for ep_val in list_ep:
                    model = SVR(kernel='rbf', gamma = gamma_val, C = c_val, epsilon = ep_val)
                    ...
                    print("C_value: {} Gamma_value: {} Epsilon_value:{} All_MSE: {} All_R2: {}".format(c_val, gamma_val, ep_val, all_mse, all_r2_score))
                    ...
                    if all_mse < min_mse:
                        ...
                        best_ep = ep_val
                        print("The best C value is: {} The best gamma is: {} The best epsilon_value:{} The best mse: {}".format(best_C,best_gamma, best_ep, all_mse))
       
        regression = SVR(kernel='rbf', gamma = best_gamma,  C = best_C, epsilon = best_ep)
...
#         plt.show()
        ...
        # read_book = open_workbook("RBF_SVR_allcon_win3_revised.xls")
        ...
        # row.write(idx_run+list_row[test_person_num]+2,3, best_gamma)
        # row.write(idx_run+list_row[test_person_num]+2,4, best_ep)
        # row.write(idx_run+list_row[test_person_num]+2,5, Monitor_timing)
        # row.write(idx_run+list_row[test_person_num]+2,6, mse1)
        # row.write(idx_run+list_row[test_person_num]+2,7, rmse1)
        # row.write(idx_run+list_row[test_person_num]+2,8, mae1)
        # row.write(idx_run+list_row[test_person_num]+2,9, r2_score1)
        # row.write(idx_run+list_row[test_person_num]+2,10, mse2)
        # row.write(idx_run+list_row[test_person_num]+2,11, rmse2)
        # row.write(idx_run+list_row[test_person_num]+2,12, mae2)
        # row.write(idx_run+list_row[test_person_num]+2,13, r2_score2)
        # row.write(idx_run+list_row[test_person_num]+2,14, mse3)
        # row.write(idx_run+list_row[test_person_num]+2,15, rmse3)
        # row.write(idx_run+list_row[test_person_num]+2,16, mae3)
        # row.write(idx_run+list_row[test_person_num]+2,17, r2_score3)
        # row.write(idx_run+list_row[test_person_num]+2,18, mse4)
        # row.write(idx_run+list_row[test_person_num]+2,19, rmse4)
        # row.write(idx_run+list_row[test_person_num]+2,20, mae4)
        # row.write(idx_run+list_row[test_person_num]+2,21, r2_score4)
        # write_book.save("RBF_SVR_allcon_win3_revised.xls")
